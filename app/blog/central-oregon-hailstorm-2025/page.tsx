...
export default function CentralOregonHailstorm2025Page() {
  return (
    ...
    >
      ...
      <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">What Happened on August 3, 2025</h2>
      <p className="text-gray-700 leading-relaxed mb-4">
        Let&apos;s get one thing straight first: the correct storm date is <strong>Sunday, August 3, 2025</strong> \u2014 not August 5. Some social media posts and one national weather outlet referenced a related secondary storm system later that week, but <a href="https://bendbulletin.com/2025/08/04/hail-high-winds-and-lightning-slam-central-oregon-in-weekend-storm/" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">The Bend Bulletin</a>, <a href="https://ktvz.com/news/2025/08/03/severe-thunderstorm-warning-issued-for-deschutes-county/" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">KTVZ</a>, and the National Weather Service all confirm the primary damaging event struck on August 3. This distinction matters for your insurance claim \u2014 your one-year clock started ticking on that date.
      </p>
