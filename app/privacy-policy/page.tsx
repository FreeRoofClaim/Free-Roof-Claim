            ...
            <section className="prose prose-lg max-w-none">
              ...
              <div className="bg-blue-50 border-l-4 border-[#2563eb] p-6 my-8 rounded-r-lg">
                <p className="text-gray-700 mb-2">
                  <strong>Questions or concerns?</strong> Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:info@freeroofpros.com" className="text-[#2563eb] hover:underline">info@freeroofpros.com</a>.
                </p>
              </div>
            </section>
